...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <description>spring-rocketmq-demo</description>
    <properties>
...
CREATE TABLE `trade_coupon`  (
  ...
  `is_used` int(0) NULL DEFAULT NULL COMMENT '是否使用 0未使用 1已使用',
...
) ENGINE = InnoDB AUTO_INCREMENT = 345959443973935105 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of trade_goods
-- ----------------------------
INSERT INTO `trade_goods` VALUES (345959443973935104, '华为P30', 999, 5000.00, '夜间拍照更美', '2019-07-09 20:38:00');
...
CREATE TABLE `trade_goods_number_log`  (
  ...
  `goods_number` int(0) NULL DEFAULT NULL COMMENT '库存数量',
...
CREATE TABLE `trade_mq_consumer_log`  (
  ...
  `consumer_status` int(0) NULL DEFAULT NULL COMMENT '0:正在处理;1:处理成功;2:处理失败',
  `consumer_times` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `trade_mq_producer_temp`  (
  ...
  `msg_body` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `msg_status` int(0) NULL DEFAULT NULL COMMENT '0:未处理;1:已经处理',
...
CREATE TABLE `trade_order`  (
  `order_id` bigint(0) NOT NULL COMMENT '订单ID',
  `user_id` bigint(0) NULL DEFAULT NULL COMMENT '用户ID',
  `order_status` int(0) NULL DEFAULT NULL COMMENT '订单状态 0未确认 1已确认 2已取消 3无效 4退款',
  `pay_status` int(0) NULL DEFAULT NULL COMMENT '支付状态 0未支付 1支付中 2已支付',
  `shipping_status` int(0) NULL DEFAULT NULL COMMENT '发货状态 0未发货 1已发货 2已收货',
  ...
  `goods_number` int(0) NULL DEFAULT NULL COMMENT '商品数量',
  `goods_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '商品价格',
...
CREATE TABLE `trade_pay`  (
  `pay_id` bigint(0) NOT NULL COMMENT '支付编号',
  `order_id` bigint(0) NULL DEFAULT NULL COMMENT '订单编号',
  `pay_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '支付金额',
  `is_paid` int(0) NULL DEFAULT NULL COMMENT '是否已支付 1否 2是',
...
CREATE TABLE `trade_user`  (
  ...
  `user_score` int(0) NULL DEFAULT NULL COMMENT '积分',
  `user_reg_time` timestamp(0) NULL DEFAULT NULL COMMENT '注册时间',
  `user_money` decimal(10, 0) NULL DEFAULT NULL COMMENT '用户余额',
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 345963634385633281 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `trade_user_money_log`  (
  ...
  `order_id` bigint(0) NOT NULL COMMENT '订单ID',
  `money_log_type` int(0) NOT NULL COMMENT '日志类型 1订单付款 2 订单退款',
