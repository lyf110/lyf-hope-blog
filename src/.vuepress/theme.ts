...
export default hopeTheme({
    hostname: "https://github.com/lyf110",

    favicon: "/favicon.ico",

    author: {
        name: "liuyangfang",
        url: "https://github.com/lyf110",
        email: "1102970594@qq.com"
    },
    ...
    locales: {
        "/": {
            ...
            footer: "主题 <a href=\"https://theme-hope.vuejs.press/zh/\">vuepress-theme-hope</a> | Apache License 2.0 Licensed",

            copyright: "Copyright © 2023-present liu yang fang",

            displayFooter: true,

            blog: {
                description: "一个工作了六年的后台开发",
                intro: "/blog.html",
            },
