...
需要将 `RpcRequestMessageHandler` 设置为 `@Sharable`

![image-20220731185713924](./assets/202207311857720.png)

```java
io.netty.channel.ChannelPipelineException: cn.lyf.server.handler.RpcRequestMessageHandler is not a @Sharable handler, so can't be added or removed multiple times.
	...
	at cn.lyf.server.RpcServer$1.initChannel(RpcServer.java:52)
	at cn.lyf.server.RpcServer$1.initChannel(RpcServer.java:44)
