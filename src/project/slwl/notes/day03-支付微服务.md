...
![](./assets/image-20240407183435207-103.gif)

# 2、需求分析
## 2.1、整体流程
![](./assets/image-20240407183435207-104.png)
流程说明：
...
## 2.2、业务功能
![](./assets/image-20240407183435207-105.png)
## 2.3、产品需求
【付款方式】判断寄付/到付交互
...
支付微服务在整个系统架构中的业务时序图：
![](./assets/image-20240407183435207-106.svg)
### 2.5.1、微服务工程规范
...
它们之间的依赖关系如下：
![](./assets/image-20240407183435207-107.png)
### 2.5.2、拉取代码
需要拉取的工程有3个：
...
![](./assets/image-20240407183435208-108.png)
![](./assets/image-20240407183435208-109.png)
git分支说明：
![](./assets/image-20240407183435208-110.png)
...
SLException的定义：
![](./assets/image-20240407183435209-119.png)
SLWebException的定义：
![](./assets/image-20240407183435209-120.png)
...
关键代码如下：
![](./assets/image-20240407183435209-121.png)
在该类中对于4种异常做处理，分别是：

- `ValidationException`
![](./assets/image-20240407183435209-122.png)
- `SLException`
![](./assets/image-20240407183435209-123.png)
- `SLWebException`
![](./assets/image-20240407183435209-124.png)
- `Exception`
![](./assets/image-20240407183435210-125.png)
#### 2.5.3.4、@Resource注入
...
![](./assets/image-20240407183435210-126.png)

![](./assets/image-20240407183435210-127.png)
两者区别：
...
![](./assets/image-20240407183435210-128.png)
...
![](./assets/image-20240407183435210-129.png)
-  具体的一些项目配置统一使用nacos的配置中心管理，并且在这里使用nacos的共享配置机制，这样可以在多个项目中共享相同的配置
![](./assets/image-20240407183435210-130.png)
#### 2.5.4.2、seata配置
```yaml
seata:
  registry:
...
```
具体的配置在微服务自身的配置文件中：
![](./assets/image-20240407183435210-131.png)
#### 2.5.4.6、xxl-job配置
```yaml
xxl:
  job:
...
![](./assets/image-20240407183435211-132.png)
> **其中表中已经包含了2条数据，分别是支付宝和微信的账号信息，可以直接与支付平台对接。**

![](./assets/image-20240407183435211-133.png)
## 3.2、阅读代码
...
![](./assets/image-20240407183435212-139.png)
![](./assets/image-20240407183435212-140.png)
...
```
使用：
![](./assets/image-20240407183435212-141.png)
## 4.4、生成二维码
...
```
生成的效果：
![](./assets/image-20240407183435212-142.png)
以上二维码对应的base64字符串如下：
```java
...
在线base64转图片工具：
## 4.5、测试
![](./assets/image-20240407183435212-143.png)
```json
{
...
```
![](./assets/image-20240407183435212-144.png)
![](./assets/image-20240407183435213-145.jpg)
## 4.6、优化（练习）
...
![](./assets/image-20240407183435213-146.svg)
...
在线查看：
![](./assets/image-20240407183435213-147.png)
...
![](./assets/image-20240407183435213-148.png)
:::
### 6.1.3、NotifyService
```java
package com.sl.ms.trade.service;
...
![](./assets/image-20240407183435214-149.png)
...
官网地址：
xxl-job架构图（官图）：
![](./assets/image-20240407183435214-150.png)
### 7.2.3、部署安装
...
![](./assets/image-20240407183435214-151.png)
安装命令：
```shell
docker run \
...
:::
xxl-job共用到8张表，如下：
![](./assets/image-20240407183435214-152.png)
:::tips
...
![](./assets/image-20240407183435214-153.png)
运行之前，首先需要创建执行管理器：
![](./assets/image-20240407183435214-154.png)
创建任务：
![](./assets/image-20240407183435214-155.png)
![](./assets/image-20240407183435214-156.png)
:::info
xxl-job支持的路由策略非常丰富：
...
### 6.2.5、调度流程
![](./assets/image-20240407183435214-157.svg)
...
![](./assets/image-20240407183435214-158.png)
创建【查询支付状态】任务：
![](./assets/image-20240407183435214-159.png)
创建【查询退款状态】任务：
![](./assets/image-20240407183435214-160.png)

本地启动服务后会看到注册的ip地址，可能是在101机器无法访问的，如下：
![](./assets/image-20240407183435214-161.png)
...
```
重新启动，效果如下：
![](./assets/image-20240407183435215-162.png)
# 7、面试连环问
:::info
面试官问：
